...
For deterministic checks (Oxford commas, em dash entities, spelling), run Vale from `expo/docs/` via `pnpm lint-prose` or `.vale/bin/vale`. The references cover what Vale cannot see.
