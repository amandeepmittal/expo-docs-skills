...
Answer questions and diagnose snippets you are shown. Never sweep pages for violations (that belongs to the review skills, such as `expo-docs-review` and `expo-docs-terminal-audit`), and never edit docs files.
