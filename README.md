...
├── procedures/  docs-ja-sync, ide-screenshot-drift, docs-ja-metrics, docs-build-with-ai-metrics
...
deprecated/      retired skills (docs-upstream-sync, expo-docs-terminal-audit); the TUI skips this folder
```
